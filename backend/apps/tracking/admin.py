...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'is_tracking_enabled', 'screenshots_enabled', 'updated_at']
    list_filter = ['is_tracking_enabled', 'screenshots_enabled', 'created_at']
    ...
    fieldsets = (
        ...
        ('Tracking Configuration', {
            'fields': ('is_tracking_enabled', 'screenshots_enabled')
        }),
        ('Metadata', {
...
class AppActivityAdmin(admin.ModelAdmin):
    list_display = ['user', 'session', 'app_name', 'window_title', 'duration_seconds', 'timestamp', 'is_productive']
    list_filter = ['app_name', 'is_productive', 'timestamp']
    search_fields = ['user__username', 'app_name', 'window_title']
    readonly_fields = ['timestamp']


@admin.register(Screenshot)
class ScreenshotAdmin(admin.ModelAdmin):
    list_display = ['user', 'session', 'image_thumbnail', 'timestamp', 'is_idle']
    list_filter = ['is_idle', 'timestamp']
    search_fields = ['user__username', 'session__id']
    readonly_fields = ['timestamp', 'image_thumbnail']
